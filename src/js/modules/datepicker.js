...
function initDatepicker(element) {
   ...
   let startDate
   let endDate
   const startEl = element.querySelector(".order-form__start-date")
   const toEl = element.querySelector(".order-form__end-date")
   ...
   let over = false
   element.querySelectorAll(".ui-datepicker").forEach((el) =>
...
document.querySelectorAll('.order-form').forEach(form => initDatepicker(form))
